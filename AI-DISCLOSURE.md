...
| `README.md`, `FEEDBACK.md`, `FEEDBACK-1INCH.md`, `aqua/README.md`, `keeper/README.md`, `arc/DEPLOYMENTS.md`, `docs/*`, this file | **AI-drafted prose, author's content.** Every finding in both feedback files is something actually hit during this build. |
